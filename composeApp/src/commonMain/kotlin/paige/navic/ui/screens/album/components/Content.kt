...
import com.flexify.app.composeapp.generated.resources.info_no_albums
			...
			is UiState.Loading -> {
				...
				item(span = { GridItemSpan(maxLineSpan) }) {
					ContentUnavailable(
						...
						label = stringResource(com.flexify.app.generated.resources.Res.string.info_no_albums)
					)
				}
			}
		}
